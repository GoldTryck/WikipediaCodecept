...
class Wiki_main_page {
  constructor() {
    this.fields = {
      lang_es: "div.central-featured-lang.lang1",
      lang_en: "div.central-featured-lang.lang2",
      lang_ja: "div.central-featured-lang.lang3",
      lang_ru: "div.central-featured-lang.lang4",
      lang_de: "div.central-featured-lang.lang5",
      lang_fr: "div.central-featured-lang.lang6",
      lang_zh: "div.central-featured-lang.lang7",
      lang_it: "div.central-featured-lang.lang8",
      lang_pt: "div.central-featured-lang.lang9",
      lang_pl: "div.central-featured-lang.lang10",
      ...
      welcome_pt: "//a[@title='Wikipédia:Boas-vindas']",        welcome_pl: "//div[@id='main-page-welcome']",
      content: "#content",
      section_references: "//h2[@id='Referencias']",
      internal_refs: "//div[@id='bodyContent']//a[starts-with(@href, '/wiki/')]"
    };
  }
    ...
    async validateSearchResults(text) {
        ...
        I.say(`Validando que el resultado de la busqueda contenga: ${text}`, 'green');
    }
    ...
    async validateWelcomeMessage(language) {
        ...
        switch (language) {
          ...
          case "Aleman":
            I.see(
              "Willkommen bei Wikipedia", this.fields.welcome_de);
            break;
          case "Frances":
    ...
    async validateSection(section) {
        I.waitForElement(this.fields.content, 10);
        I.say(`Validando la seccion ${section}`, 'white');
        switch (section) {
          case "Referencias":
            I.see("Referencias", this.fields.section_references);
            break;
          default:
    ...
    async validateInternalLinks(links) {
        ...
        for (const link of links) {
            ...
            console.log(`Validando el enlace: ${url}`);
        
            try {
                const res = await axios.head(url);

                if (res.status !== 200) {
                    throw new Error(`El enlace ${url} no es válido. Status: ${res.status}`);
                }
